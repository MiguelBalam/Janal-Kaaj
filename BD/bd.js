...
function registrarse(){
 ...
 var Nombre= document.querySelector("#nombrecompletos").value;
 var ApellidoP = document.querySelector("#apellidopaterno").value;
 var ApellidoM= document.querySelector("#apellidomaterno").value;
 var Genero= document.querySelector("#inlineRadio1").value;
 var Genero2= document.querySelector("#inlineRadio2").value;
var Edad= document.querySelector("#edad").value;
var Proce= document.querySelector("#procedencia").value;
var Telefono = document.querySelector("#tel").value;
 ...
 .objectStore("Usuario")
 .add({ApellidoP:ApellidoP, Nombre:Nombre, ApellidoM:ApellidoM, Genero:Genero, Genero2:Genero2, Edad:Edad, Telefono:Telefono});
 ...
 var request = db.transaction(["Encuestador"], "readwrite")
 .objectStore("Encuestador")
 .add({Proce:Proce});
...
//cadena += "<tr><th>Nombre</th> <th>Apellido Paterno</th> <th>Apellido Materno</th> <th>Telefono</th> </tr>";
//var num = 0;
