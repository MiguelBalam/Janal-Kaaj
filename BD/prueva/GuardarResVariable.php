...
$insertDatosEncuestado = "INSERT INTO encuestado_respuesta(nombre, localidad, genero, edad, codigo,Aplicador)
                          VALUES ('$nombre', '$localidad', '$genero', '$edad', '$codigo','$Aplicador')";
