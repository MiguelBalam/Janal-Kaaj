...
/***/ function(module, exports, __webpack_require__) {
	...
	Card = (function() {
	  ...
	  Card.prototype.defaults = {
	    formatting: true,
	    formSelectors: {
	      numberInput: 'input[name="tarjeta"]',
	    ...
	    setCardType: function($el, e) {
	      ...
	      if (!QJ.hasClass(this.$card, cardType)) {
	        ...
	        QJ.toggleClass(this.$card, 'jp-card-identified', cardType !== 'unknown');
			  jQuery('#cntTarjeta').attr('class', 'jp-card-focused '+cardType);
			  
			  
			  //console.log('input ' + cardType);
	...
	(function() {
	  ...
	  formatCardNumber = function(e) {
		...
		if(card){
			...
			$('.tarjetas a').removeClass('active');
			if(val == ''){				
				return false;
			}			
			$('.tarjetas').addClass('active');
			$('.tarjetas a[data-id=' + val + ']').addClass('active');
			$('#marca').val(val)//*/
		}
...
jQuery( document ).ready(function() {
	...
	$.fn.frmTarjetaV3 = function(){
		...
		$('#cerrar').bind('click', function(){
			$('#winPagoTarjetaV3, #overlay').fadeOut(500, function(){
				$('#winPagoTarjetaV3, #overlay').remove();
			});
		});
		...
		$('.lblF2 em').hover(function() {
			$('.tooltipC').addClass('visible animated fadeIn');
        }, function(){
			$('.tooltipC').removeClass('visible animated fadeIn');
		});
		
		//Pruebas
		/*OpenPay.setId('mwbfbgmyqufwwe7citgu');
        OpenPay.setApiKey('pk_4d331b7244744d4592b6250206101907');
		...
		var btn = '<span><i class="fa fa-check"></i>Procesar Pago</span>';
		...
		var et5 = 'Favor escribir los 4 digitos del código de seguridad.';
	 	...
	 	$('#frmAddCard').submit(function(e) {
			...
			var numTarj = $('input[name="tarjeta"]').val();
			//console.log(numTarj);
			if(numTarj == ''){
				alert(e2);
				return false;
			...
			$('#cardNumber').val(tarjLimp);
			//console.log(tarjLimp);
			
			$('#pay-button').attr('disabled','-1').html('<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i> Espere...');
		...
		var sucess_callbak = function(response) {
			...
			console.log(url, datos + '&marca=' + marca + '&tokenp=' + tokenp)
			$.post(url, datos + '&marca=' + marca + '&tokenp=' + tokenp,
				function(data){
					try{
						var result = jQuery.parseJSON(data);
						$("#pay-button").removeAttr('disabled').html('<span><i class="fa fa-check"></i>Procesar Pago</span>');
	...
	$.fn.winPagoTajeta = function(url){
		$.fancybox({
				...
				beforeShow : function(){
				 	$(".fancybox-skin").parents('.fancybox-wrap').addClass("winPagoTarjeta");					
				...
				beforeClose:function(){
					...
					$('html').removeClass('noLoadingFancy');
				},
				wrapCSS : 'winPagoTarjeta nPagoTarjeta'
			});
	};

	$('#btnOpenP').click(function(){
		var url = $(this).data('href');
  		var id = $(this).data('token');
  		$(document).winPagoTajeta(url);	
	});
